...
export default function LandingPage() {
  ...
  <div id="hero" data-section="hero">
      ...
      testimonials={[
        ...
        },
        {
          ...
          handle: "@DeFiVisionary",
          testimonial: "Trustworthy and innovative. CryptoForge is truly shaping the future of finance.",
          rating: 5,
        ...
        {
          name: "David Kim",
          handle: "@DigitalAssetGuru",
          testimonial: "Finally, a platform that combines advanced features with top-tier security. Highly recommend!",
          rating: 5,
          imageSrc: "http://img.b2bpic.net/free-photo/thoughtful-senior-businessman-portrait_1262-1636.jpg",
          imageAlt: "David Kim",
        },
        {
          name: "Jessica Lee",
          handle: "@TokenTitan",
          testimonial: "The best platform for staking and yield farming. My passive income has soared!",
          rating: 5,
          imageSrc: "http://img.b2bpic.net/free-photo/close-up-business-woman-with-disabilities-looking-sad-front-while-diverse-team-working-financial-project_482257-2221.jpg",
      ...
      avatars={[
        {
          src: "http://img.b2bpic.net/free-photo/money-fantasy-scene_23-2151663128.jpg",
          alt: "Avatar of crypto user 1",
        },
        {
          src: "http://img.b2bpic.net/free-photo/three-businesspersons-desk_23-2147626400.jpg",
          alt: "Avatar of crypto user 2",
        },
        {
          src: "http://img.b2bpic.net/free-photo/front-view-elegant-mature-male-holding-tablet_23-2148673422.jpg",
          alt: "Avatar of crypto user 3",
        },
        {
          src: "http://img.b2bpic.net/free-photo/portrait-man-christmas-celebrations_23-2150936477.jpg",
          alt: "Avatar of crypto user 4",
        },
        {
          src: "http://img.b2bpic.net/free-photo/portrait-happy-businessman-showing-bitcoin_171337-385.jpg",
          alt: "Confident crypto investor",
        },
      ]}
  ...
  <div id="features" data-section="features">
      ...
      features={[
        {
          title: "Intuitive Trading Terminal",
          description: "Access real-time market data, advanced charting tools, and lightning-fast execution for all major cryptocurrencies. Trade with confidence.",
          phoneOne: {
            ...
            imageAlt: "Crypto trading terminal on phone",
          },
          phoneTwo: {
        ...
        {
          title: "Decentralized Finance (DeFi) Hub",
          description: "Dive into the world of DeFi with seamless access to lending, borrowing, and yield farming protocols. Maximize your earnings in a trustless environment.",
          phoneOne: {
            imageSrc: "http://img.b2bpic.net/free-photo/3d-rendering-blockchain-technology_23-2151480185.jpg",
            imageAlt: "DeFi platform on tablet",
          },
          phoneTwo: {
        ...
        },
        {
          ...
          description: "Track your investments with comprehensive analytics, set custom alerts, and gain insights into your portfolio's performance across all assets.",
          phoneOne: {
            imageSrc: "http://img.b2bpic.net/free-photo/still-life-arrangement-with-cryptocurrency_23-2149102130.jpg",
            imageAlt: "Crypto portfolio tracker on laptop",
          },
          phoneTwo: {
  ...
  <div id="products" data-section="products">
      ...
      products={[
        ...
        },
        {
          ...
          name: "Ethereum (ETH)",
          price: "$3,200",
          variant: "Smart Contracts Powerhouse",
        ...
        },
        {
          ...
          name: "Ripple (XRP)",
          price: "$0.55",
          variant: "Global Payments Network",
          imageSrc: "http://img.b2bpic.net/free-vector/crypto-coin-bitcoin-logo-new-design_483537-4798.jpg",
        ...
        },
        {
          ...
          name: "Cardano (ADA)",
          price: "$0.40",
          variant: "Peer-Reviewed Blockchain",
          imageSrc: "http://img.b2bpic.net/free-photo/abstract-creative-3d-sphere_23-2150885355.jpg",
          imageAlt: "Cardano icon",
        },
        {
          id: "litecoin",
          name: "Litecoin (LTC)",
          price: "$80",
          variant: "The Silver to Bitcoin's Gold",
          imageSrc: "http://img.b2bpic.net/free-vector/collection-cryptocurrency-coins_23-2147788784.jpg",
          imageAlt: "Litecoin icon",
        },
      ]}
      ...
      plans={[
        {
          ...
          imageSrc: "http://img.b2bpic.net/free-photo/computer-servers-row-network-generated-by-ai_188544-27795.jpg",
          imageAlt: "Basic access node",
        },
        {
          id: "pro",
          title: "Pro Trader",
          ...
          imageSrc: "http://img.b2bpic.net/free-photo/cyber-security-concept-digital-art_23-2151637766.jpg",
          imageAlt: "Pro trader network",
        },
        {
          id: "enterprise",
          ...
          imageAlt: "Enterprise global network",
        },
      ]}
      ...
      testimonials={[
        {
          ...
          name: "Alex T.",
          handle: "@CryptoMind",
          testimonial: "CryptoForge has truly simplified my investment strategy. The interface is clean, and the security gives me peace of mind. Best decision I ever made!",
          rating: 5,
          ...
          imageAlt: "Alex T. trading crypto",
        },
        {
          id: "2",
          name: "Brenda J.",
          handle: "@BlockchainBelle",
          testimonial: "I've tried several platforms, but CryptoForge stands out. Their analytics tools are incredibly powerful, helping me make smarter moves. Highly recommend!",
          rating: 5,
          imageSrc: "http://img.b2bpic.net/free-photo/portrait-cheerful-businessman-showing-bitcoin_171337-387.jpg",
          imageAlt: "Brenda J. reviewing portfolio",
        },
        {
          id: "3",
          name: "Chris P.",
          handle: "@DeFiDynamo",
          testimonial: "The DeFi integration on CryptoForge is a game-changer. I'm earning passive income effortlessly, and their support team is always there to help.",
          rating: 5,
          ...
          imageAlt: "Chris P. discussing crypto",
        },
        {
          id: "4",
          name: "Diana S.",
          handle: "@TokenTrailblazer",
          testimonial: "Security is my top priority, and CryptoForge exceeds expectations. I feel completely safe trading and storing my assets here. A truly robust platform.",
          rating: 5,
          imageSrc: "http://img.b2bpic.net/free-photo/medium-shot-man-wearing-headphones_23-2149153410.jpg",
          imageAlt: "Diana S. making secure transaction",
        },
        {
          id: "5",
          name: "Ethan L.",
          handle: "@HodlHero",
          testimonial: "The educational resources and market insights provided by CryptoForge are fantastic. I've learned so much and seen my portfolio grow significantly.",
          rating: 5,
          imageSrc: "http://img.b2bpic.net/free-photo/young-successful-confident-woman-with-glasses-holds-gold-bitcoin-her-hand-isolated-black-wall_231208-11713.jpg",
          imageAlt: "Ethan L. with successful investment",
        },
      ]}
      showRating={true}
  ...
  <div id="faq" data-section="faq">
      ...
      faqs={[
        {
          id: "1",
          title: "What is CryptoForge?",
          content: "CryptoForge is a leading digital asset trading and management platform designed for both beginners and experienced investors to securely buy, sell, and manage cryptocurrencies.",
        },
        {
          id: "2",
          title: "How do I secure my account?",
          content: "We recommend enabling Two-Factor Authentication (2FA) for all accounts, using a strong, unique password, and being vigilant against phishing attempts. Our platform uses advanced encryption for all data.",
        },
        {
          id: "3",
          title: "What cryptocurrencies can I trade?",
          content: "CryptoForge supports a wide range of popular cryptocurrencies including Bitcoin (BTC), Ethereum (ETH), Solana (SOL), Ripple (XRP), Cardano (ADA), and many more altcoins. New assets are added regularly.",
        },
        {
          id: "4",
          title: "How are my assets protected?",
          content: "Your assets are protected through a combination of cold storage, multi-signature wallets, and regular security audits. We prioritize the safety of your funds above all else.",
        },
        {
          id: "5",
          title: "What is DeFi and how can I participate?",
          content: "DeFi (Decentralized Finance) refers to financial services built on blockchain technology. On CryptoForge, you can participate in DeFi protocols like staking and yield farming to earn passive income, directly from your dashboard.",
        },
      ]}
  ...
  <div id="footer" data-section="footer">
      ...
      socialLinks={[
        {
          icon: Twitter,
          href: "https://twitter.com/cryptoforge",
          ariaLabel: "Twitter",
        },
        {
          icon: MessageCircle,
          href: "https://discord.com/cryptoforge",
          ariaLabel: "Discord",
        },
        {
          icon: Linkedin,
          href: "https://linkedin.com/company/cryptoforge",
          ariaLabel: "LinkedIn",
        },
      ]}
    />
